...
describe("Commmon", function () {
  it("Normal", function () {
    assert("hello world", [{ start: 0, end: 11, type: "text", text: "hello world" }]);
    ...
    assert("start: <div id=1><span>click <a href=here>link</a></span></div> end", [
      {
        start: 0,
        end: 7,
        type: "text",
    ...
    assert('<html><body><h1>Title</h1><div id="main" class="test"><p>Hello<em>world</em>!</p></div></body></html>', [
      {
        start: 0,
        end: 101,
        type: "tag",
            ...
            children: [
              {
                ...
                type: "tag",
                name: "h1",
                children: [{ start: 16, end: 21, type: "text", text: "Title" }],
              },
              {
                start: 26,
                end: 87,
                ...
                children: [
                  {
                    ...
                    children: [
                      { start: 57, end: 62, type: "text", text: "Hello" },
                      {
                        ...
                        type: "tag",
                        name: "em",
                        children: [{ start: 66, end: 71, type: "text", text: "world" }],
                      },
